...
u1 = User.create(full_name: "Kevin Wong", picture_url: "kevin.jpg", phone_number: "3058785704" ,email: "kwong@gmail.com", uid: "id123", oauth_token:"faketoken1", oauth_expires_at: expiration_date, provider: "facebook")
